...
class TotalTextoader(data.Dataset):
    def __init__(self,root_dir, split='train', is_transform=False, img_size=None, kernel_num=7,min_scale=0.4):
        self.split = split
        ...
        total_text_train_data_dir = self.root_dir + 'Images/Train/'
        total_text_train_gt_dir = self.root_dir + 'gt/Train/'
        total_text_test_data_dir = self.root_dir + 'Images/Test/'
        total_text_test_gt_dir = self.root_dir + 'Groundtruth/Polygon/Test/'
