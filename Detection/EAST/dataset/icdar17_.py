...
class ICDAR17(data.Dataset):
    def __init__(self, img_path,gt_path, scale=0.25, length=640):
        ...
        self.scales = [0.5, 0.6, 0.7, 0.8, 0.9, 1.0, 1.2, 1.3, 1.4, 1.5, 1.6, 1.8, 1.9, 2.0]
    ...
    def __getitem__(self, index):
        ...
        img, vertices = random_scale(img, vertices, self.scales)
...
if __name__ == "__main__":
    ...
    for i, (img, gt_score, gt_geo, ignored_map) in enumerate(train_loader):
        ...
        img_show = ((img_show * (0.5, 0.5, 0.5) + (0.5, 0.5, 0.5)) * 255).astype(np.uint8)
